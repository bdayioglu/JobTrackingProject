...
namespace WebUI.Areas.Admin.Controllers
{
    ...
    [Area(AreaInfo.Admin)]
    public class İşEmriController : Controller
    {
        ...
        public İşEmriController(IAppUserService appUserService, IGorevService gorevService, UserManager<AppUser> userManager, IDosyaService dosyaService, IBildirimService bildirimService, IMapper mapper)
        {
            _mapper = mapper;
        ...
        {
            TempData["Active"] = TempdataInfo.İşEmri;
